...
<body class="A4 landscape">
  ...
  <section class="sheet padding-10mm " style="height: auto;font-size: 10px;">
    ...
    <h4 class="text-center">Laporan Penggantian ONT <?= date("M", strtotime($_GET['bulan']));  ?> <?= date("y", strtotime($_GET['bulan']));  ?></h4>
    <hr>
