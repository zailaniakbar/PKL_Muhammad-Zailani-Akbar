  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Halaman Edit Transaksi Ganti ONT</h1>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    </section>
    ...
    <section class="content">
      ...
      <div class="card">
        ...
        <div class="card-body">
          ...
          $id = $_GET['id']; 
          $data   = mysqli_query($koneksi, "select * from ganti_ont where id = '$id'");
          ...
          <form action="" method="post" role="form">
            ...
            <div class="form-group">
              ...
              <select class="form-control  col-sm-4" name="ont_baru_id" disabled="">
                ...
                ?> 
                <option value="<?= $rowv['id'] ?>" <?= ($rowv['id'] == $row['ont_baru_id']) ? 'selected' : ''; ?>><?= $rowv['tipe'] ?> | SN : <?= $rowv['sn'] ?></option>
              <?php } ?>
              </select>
            </div>
...
<?php
        ...
        if (isset($_POST['submit'])) {
          ...
          $datas = mysqli_query($koneksi, "update ganti_ont set tgl_ganti = '$tgl_ganti',sn_lama = '$sn_lama',ket = '$ket' where id = '$id'") or die(mysqli_error($koneksi));
            echo "<script>alert('data berhasil diubah.');window.location='ganti_ont-index.php';</script>";
        }
        ?>
  <?php
