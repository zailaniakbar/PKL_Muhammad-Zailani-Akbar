...
<body class="A4 ">
  ...
  <section class="sheet padding-10mm " style="height: auto;font-size: 10px;">
    ...
    <h4 class="text-center">Laporan Stok ONT</h4>
    <hr>
           <?php
              include('koneksi.php'); //memanggil file koneksi
              $datas_ont = mysqli_query($koneksi, "select (select count(*) from stok_ont where status ='1')  as total_ont, (select count(*) from stok_ont where status != '1' or status is null)  as total_ont_ready") or die(mysqli_error($koneksi));
              ...
              <span class="btn btn-info btn-sm float-right mr-2">Stok ONT Digunakan : <?= $row_total['total_ont_ready']; ?></span>
