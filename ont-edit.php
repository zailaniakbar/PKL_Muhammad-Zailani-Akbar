    ...
    <section class="content">
      ...
      <div class="card">
        ...
        <div class="card-body">
          ...
          $data   = mysqli_query($koneksi, "select * from stok_ont where id = '$id'");
...
<?php
        ...
        if (isset($_POST['submit'])) {
          ...
          mysqli_query($koneksi, "update stok_ont set tipe='$tipe',sn='$sn' where id ='$id'") or die(mysqli_error($koneksi));

          //redirect ke halaman index.php
          echo "<script>alert('data berhasil diupdate.');window.location='ont-index.php';</script>";
        }
        ?>
  <?php
